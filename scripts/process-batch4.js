// Script to process batch 4 raw ideas through the enhance-idea API
import fs from 'fs';
...
const RAW_IDEAS_FILE = path.join(__dirname, 'raw-ideas-batch4.json');
const OUTPUT_FILE = path.join(__dirname, 'enhanced-ideas-batch4.json');
...
async function processAllIdeas() {
  console.log('Loading batch 4 raw ideas...');
