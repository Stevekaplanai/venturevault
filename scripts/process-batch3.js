// Script to process batch 3 raw ideas through the enhance-idea API
import fs from 'fs';
...
const RAW_IDEAS_FILE = path.join(__dirname, 'raw-ideas-batch3.json');
const OUTPUT_FILE = path.join(__dirname, 'enhanced-ideas-batch3.json');
...
async function processAllIdeas() {
  console.log('Loading batch 3 raw ideas...');
