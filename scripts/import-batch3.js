// Script to import batch 3 enhanced ideas to Supabase
import fs from 'fs';
...
const ENHANCED_IDEAS_FILE = path.join(__dirname, 'enhanced-ideas-batch3.json');

async function importIdeas() {
  console.log('Loading batch 3 enhanced ideas...');
