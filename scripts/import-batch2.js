// Script to import batch 2 enhanced ideas to Supabase
// Run with: node scripts/import-batch2.js
...
const ENHANCED_IDEAS_FILE = path.join(__dirname, 'enhanced-ideas-batch2.json');

async function importIdeas() {
  console.log('Loading batch 2 enhanced ideas...');
