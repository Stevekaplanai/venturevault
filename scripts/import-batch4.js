// Script to import batch 4 enhanced ideas to Supabase
import fs from 'fs';
...
const ENHANCED_IDEAS_FILE = path.join(__dirname, 'enhanced-ideas-batch4.json');

async function importIdeas() {
  console.log('Loading batch 4 enhanced ideas...');
